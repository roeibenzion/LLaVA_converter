...
class LlavaMetaForCausalLM(ABC):
    ...
    def initialize_fga(self, util_e, sharing_factor,prior_flag, sizes, size_force, similar_modalities=[]):
        self.atten = Atten(util_e, sharing_factor, prior_flag, sizes, size_force, similar_modalities=similar_modalities)
        return self.atten
